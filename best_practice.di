    ...
    <sashModel currentSelection="/0/@sashModel/@windows.0/@children.0">
      <windows>
        <children xsi:type="di:TabFolder">
          <children>
            <emfPageIdentifier href="best_practice.notation#_m5Ti4MVDEe2enYiSLj8eBQ"/>
          </children>
        </children>
      </windows>
    </sashModel>
  </di:SashWindowsMngr>
  <architecture:ArchitectureDescription contextId="org.eclipse.papyrus.infra.services.edit.TypeContext"/>
  <architecture:ArchitectureDescriptionPreferences>
    <viewpointIds>org.eclipse.papyrus.uml.analysis</viewpointIds>
    <viewpointIds>org.eclipse.papyrus.uml.design</viewpointIds>
  </architecture:ArchitectureDescriptionPreferences>
</xmi:XMI>
